                ...
                <div class="col-xl-4 col-xxl-3 col-lg-4 pe-0">
                    ...
                    <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3" style="overflow: auto;">
                        ...
                        <!-- <div class="card-body d-flex pt-0 ps-4 pe-4 pb-3 overflow-hidden">
                            ...
                            <h4 class="fw-700 text-gcrey-900 font-xssss mt-2">Developer Programe <span class="d-block font-xsssss fw-500 mt-1 lh-4 text-grey-500">41 madison ave, floor 24 new work, NY 10010</span> </h4>
                        </div>
