      ...
      <div class="row feed-body" style="overflow: auto; height: auto">
        <div class="col-xl-8 col-xxl-9 col-lg-8">
          ...
          <!-- svelte-ignore missing-declaration -->
			<form method="POST" action="?/createPost" use:enhance class="card w-100 shadow-xss rounded-xxl border-0 ps-4 pt-4 pe-4 pb-3 mb-3">
				...
				<input name="post-image" id="my-image" style="display: none;" type="file">
				</div>
